...
import { useProjectUpdater } from "../../../../data/videosos/mutations";
import {
  queryKeys,
  useProject,
  useProjectMediaItems,
  useVideoComposition,
} from "../../../../data/videosos/queries";
import { type MediaItem, PROJECT_PLACEHOLDER } from "../../../../data/videosos/schema";
import {
  type MediaType,
  useProjectId,
...
import { resolveMediaUrl } from "../../../../lib/videosos/utils";
